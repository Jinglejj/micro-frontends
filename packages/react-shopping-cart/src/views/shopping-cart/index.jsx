...
const commodityList = [
  {
    ...
    count: 1,
    imageUrl:
      "https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/MWP22?wid=1144&hei=1144&fmt=jpeg&qlt=80&op_usm=0.5,0.5&.v=1591634795000",
  },
  {
    id: 2,
    title: "AirPods Pro",
...
class ShoppingCart extends Component {
  ...
  render() {
    ...
    const commidity = commodityList.map((c) => (
      <Commidity
        key={c.id}
        commidity={c}
    ...
    return (
      <ShoppingCartContainer>
        ...
        <CommidityContainer>{commidity}</CommidityContainer>
        <BottomInfo subTotal={subTotal} />
      </ShoppingCartContainer>
    );
  }
  handleAdd(id) {
